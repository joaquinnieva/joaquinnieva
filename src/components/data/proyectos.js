  ...
  },
  {
    ...
    description: (
      <p>
        ...
        &nbsp;🚀, es un proyecto trabajado en equipo empleando Scrum como metodología y Jira para la gestión de tareas, el objetivo del proyecto era crear una
        app gestionable para admins donde pueden crear noticias y testimonios, además de desplegar información de la organización.
        <br />
        <a
    ...
    img: imagen6,
    tecnologies: ["react", "react-router", "redux-sagas", "bootstrap", "formik", "axios"],
